...
export function FeaturesList({ filters = {} }: FeaturesListProps) {
  const { t, ready } = useTranslation();
  const { features, loading, error } = useFeatures(filters);
        ...
        <CardContent className="pt-6">
          <div className="text-center text-gray-500">
            ...
            <p className="mt-1 text-sm text-gray-500">
              {t("features.table.noFeaturesDescription")}
            </p>
          </div>
        </CardContent>
      </Card>
